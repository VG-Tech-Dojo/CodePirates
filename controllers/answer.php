...
$app->get('/answer/:a_id', 'authorized' ,function ($a_id) use ($app) {
    ...
    $error_msg = $_SESSION['slim.flash'];
    $app->render('answer/answer.twig', array('user' => $user_info, 'answer' => $answerInfo ,'question' => $questionInfo, 'answerer' => $answererInfo, 'comment' => $answer_comment, 'sessionid' => $sessionid, 'like' => $like, 'error_msg' => $error_msg ));
});
