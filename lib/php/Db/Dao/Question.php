...
class Db_Dao_Question extends Db_Dao_Abstract
{
    ...
    public function findByQuestionId($questionId)
    {
        ...
        $query  = 'select question.id as id, question.title as title, question.content as content, question.inputfile_url as inputfile, question.created_at as created_at,question.inputfile_url as inputfile_url, difficulty.content as difficulty  from question, difficulty where question.difficulty = difficulty.id and question.id = :Question_ID';
